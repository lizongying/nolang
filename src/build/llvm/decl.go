...
func (g *Generator) writeDeclarations(sb *strings.Builder) {
	...
	// strtod is retained for FFI use (ffi-cstr-at-float builtin reads C string
	// arrays from foreign functions like MySQL mysql_fetch_row and parses them
	// as f64). Standard library str.to-f64 / str.to-f32 no longer use strtod;
