...
func init() {
	...
	BuiltinMethodList = append(BuiltinMethodList, BuiltinMethod{
		...
		CLibCall: &CLibCall{FuncName: "kill", AltFuncs: altWin("nolang.win_kill"), ArgTypes: []LLVMArgType{LLVMI32, LLVMI32}, RetType: LLVMI32, CmpRet: true, TruncArgs: map[int]LLVMArgType{0: LLVMI32, 1: LLVMI32}},
	})
	...
	BuiltinMethodList = append(BuiltinMethodList, BuiltinMethod{
		...
		CLibCall:     &CLibCall{FuncName: "dup2", AltFuncs: altWin("_dup2"), ArgTypes: []LLVMArgType{LLVMI32, LLVMI32}, RetType: LLVMI32, RetExt: &i64Type, TruncArgs: map[int]LLVMArgType{0: LLVMI32, 1: LLVMI32}},
	})
	...
	BuiltinMethodList = append(BuiltinMethodList, BuiltinMethod{
		...
		CLibCall:     &CLibCall{FuncName: "getppid", AltFuncs: altWin("nolang.win_getppid"), ArgTypes: []LLVMArgType{}, RetType: LLVMI32, RetExt: &i64Type},
	})
